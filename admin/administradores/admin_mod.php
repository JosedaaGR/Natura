...
if (isset($_POST['aux'])) {
    ...
    $usuario_CodPK = str_replace("'", "\"", $_POST['usuario_CodPK']);
    ...
    if ($errores == "") {
        $res = $admin->modificarAdmin($usuario_Nombre, $usuario_Email, $usuario_Usuario,$usuario_Pass, $usuario_CodPK);

        if ($usuario_CodPK == $vectorUsuario['usuario_CodPK']){
            $_SESSION['username_pcontrol_new5'] = $usuario_Pass;
            $_SESSION['password_pcontrol_new5'] = $usuario_Usuario;}

        if ($res == true)
            print("<script>document.location.href='admin_mod.php?usuario_CodPK=" . $usuario_CodPK . "&mensaje=• Admin modificado.'</script>");
        else {
            $errores = "• Error: Admin NO modificado.";
            EjecutarError();
        }
    } //fin if($errores=="")
    else
                ...
                <div class="l-row l-spaced-bottom">
                    <div class="l-box">
                        <div class="l-box-header">
                            <h2 class="l-box-title">Modificar Admin</h2>
                        ...
                        <div class="l-box-body l-spaced">
                            <form id="validateDefault" role="form" class="form-horizontal" method="post" action="admin_mod.php" data-parsley-validate>
                                <div role="application" class="wizard clearfix" id="steps-uid-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input id="usuario_Email" name="usuario_Email" value="<?PHP print($usuario_Email); ?>" type="email" class="form-control" required>
                                        </div>
                                        <div class="col-sm-4">
                                            <label for="usuario_Usuario" class=" control-label">Usuario *</label>
                                            <input id="usuario_Usuario" name="usuario_Usuario" value="<?PHP print($usuario_Usuario); ?>" type="text" class="form-control required" aria-required="true" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <input id="usuario_Pass" name="usuario_Pass" value="<?PHP print($usuario_Pass); ?>" type="password" class="form-control" required>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="rusuario_Pass" class="control-label">R. Contraseña *</label>
                                            <input id="rusuario_Pass" name="rusuario_Pass" value="<?PHP print($usuario_Pass); ?>" type="password" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
