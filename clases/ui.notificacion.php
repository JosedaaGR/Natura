...
function EjecutarError(){
	echo "<a id=\"toastr_swing\"></a>
		  <script src=\"https://code.jquery.com/jquery-1.10.2.min.js\"></script>
		  <script>
			  $(document).ready(function(){ 
			     setTimeout(clickbutton,500); function clickbutton() { 
					$(\"#toastr_swing\").click();
				  }
			   });
		   </script>";
...
function EjecutarCorrecto(){
	echo "<a id=\"toastr_2\"></a>
		  <script src=\"https://code.jquery.com/jquery-1.10.2.min.js\"></script>
		  <script>
			  $(document).ready(function(){ 
			     setTimeout(clickbutton,500); function clickbutton() { 
...
function EjecutarInfo(){
	echo "<a id=\"toastr_1\"></a>
		  <script src=\"https://code.jquery.com/jquery-1.10.2.min.js\"></script>
		  <script>
			  $(document).ready(function(){ 
			     setTimeout(clickbutton,500); function clickbutton() { 
...
function runToastr(obj){
    ...
    $(obj.elem).on( "click", function(e) {
        ...
        switch(obj.type){
            ...
            case 'basic':
                toastr.info('<?php echo "$mensaje" ?>', 'Informacion');
            break;
            ...
            case 'easing':
                ...
                toastr.warning('<?php echo "$mensaje" ?>');
...
$(function(){
    ...
    var jGrowl_1 = {elem:"#jGrowl_1", type:"basic"},
        ...
        toastr_swing   = {elem:"#toastr_swing",   type:"easing", effect: 'slide'},
